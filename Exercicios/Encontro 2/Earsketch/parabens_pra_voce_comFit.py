...
fitMedia(la, 1, 7.8, 8)
fitMedia(do, 2, 8, 8.5)
setEffect(2, PITCHSHIFT, PITCHSHIFT_SHIFT, 12, 8, 12, 11)
...
setEffect(2, PITCHSHIFT, PITCHSHIFT_SHIFT, -1, 11, -1, 14)
setEffect(2, VOLUME, GAIN, 3)
...
# palmas
palmas = [AK_UNDOG_CLAPS_SNAPS_2, AK_UNDOG_CLAPS_SNAPS_1, AK_UNDOG_CLAPS_SNAPS_3, CIARA_SET_PERC_CLAP_1]

fitMedia(palmas[3], 7, 1, 14)
fitMedia(palmas[0], 4, 1.02, 14)
fitMedia(palmas[1], 5, 1.04, 14)
fitMedia(palmas[2], 6, 1.06, 14)
